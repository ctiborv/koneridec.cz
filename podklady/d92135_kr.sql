...
-- Vytvořeno: Sob 08. čec 2017, 10:28
...
(8, ' Fabulous website - Ted Tenerife\r <br /> \r <br />  <a href="http://www.tenerife-weather.spain-and-spanish.co.uk">http://www.tenerife-weather.sp&hellip;</a> ', 'Ted Tenerife', '18:01/20.12.2016', 0, '', 'www.spain-and-spanish.co.uk', '86.13.203.169'),
(9, ' Projížďka neměla chybu! Koníci moc hodní a poslušní. Děkujeme a určitě se vrátíme!', 'Katy', '21:09/22.5.2017', 0, '', '', '217.196.124.254');
...
DROP TABLE IF EXISTS `gb_ip_ban`;
...
--
-- Vypisuji data pro tabulku `gb_ip_ban`
--

INSERT INTO `gb_ip_ban` (`id`, `ip`) VALUES
(1, '36.80.91.23'),
(2, '36.72.173.129'),
(3, '36.72.190.19'),
(4, '36.80.1.155');
...
DROP TABLE IF EXISTS `gb_nastaveni`;
...
DROP TABLE IF EXISTS `hlavnimenu`;
...
(1, 'Jolanka', '<h1>Jolanka</h1>\r\n<p><img style="float: right;" src="/img/img_5537.jpg" alt="" /><br /><br />Jm&eacute;no: <strong>JOLANKA</strong><br />Typ: chladnokrevn&yacute;<br />Pohlav&iacute;: klisna<br />Otec: ---<br />Matka: 13/450 Jalta<br />Datum narozen&iacute;: 11.2.2005<br />Barva: prokvetl&aacute; tmav&aacute; hnědka ( dle průkazu ),ve skutečnosti prkvt.tm.běl.&nbsp; smiley<br /><br />Povaha: hodn&aacute; a mazliv&aacute;, v ter&eacute;nu, vzhledem k typu koně chodiv&aacute;, r&aacute;d&aacute; i cv&aacute;l&aacute;, pohodln&yacute; pracovn&iacute; klus, v z&aacute;přahu zač&aacute;tečn&iacute;k<br /><br /><br /></p>', 2),
(2, 'Mc Scream', '<div id="heading-content">\r\n<h1>MC SCREAM</h1>\r\n</div>\r\n<div class="editable">\r\n<p><img style="float: right;" src="/img/p8300718.jpg" alt="" /></p>\r\n<p>&nbsp;</p>\r\n<p><span style="font-size: 16px;"><strong> Plemeno:</strong> česk&yacute; teplokrevn&iacute;k<br /> <strong>Pohlav&iacute;:</strong> valach ( kastrace 6.4.2011 )<br /> <strong>Otec:</strong> 1165 Toy de Maziere<br /> <strong>Matka:</strong> 68/396 Nigela<br /> <strong>Datum narozen&iacute;:</strong> 9.6.2008<br /> <strong>Barva:</strong> ryz&aacute;k</span></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n</div>', 3),
(3, 'Monti Džek', '<div id="heading-content">\r\n<h1>MONTI DŽEK</h1>\r\n</div>\r\n<div class="editable">\r\n<p><img style="float: right;" src="/img/img_5511.jpg" alt="" /></p>\r\n<p>&nbsp;</p>\r\n<p><span style="font-size: 16px;"><strong> Plemeno</strong>: česk&yacute; teplokrevn&iacute;k<br /> <strong>Pohlav&iacute;</strong>: valach<br /> <strong>Otec</strong>: 718 Mineral s.v.<br /> <strong>Matka</strong>: 67/179 Meiti<br /> <strong>Datum narozen&iacute;:</strong> 9.3.2000<br /> <strong>Barva</strong>: hněd&aacute;k ( dle průkazu ), </span><br /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <span style="font-size: 16px;">ve</span>&nbsp;<span style="font-size: 16px;">skutečnosti&nbsp;</span><span style="font-size: 16px;">ryz&aacute;k</span></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n</div>', 4),
...
(5, 'Queen´s Orphan', '<div id="heading-content">\r\n<h1>QUEEN&acute;S&nbsp; ORPHAN</h1>\r\n</div>\r\n<div class="editable">\r\n<p><br /> <img style="float: right;" src="/img/dsc07411.jpg" alt="" /></p>\r\n<p style="text-align: justify;"><span style="font-size: 16px;"><br /> <strong>Plemeno</strong>: česk&yacute; teplokrevn&iacute;k<br /> <strong>Pohlav&iacute;:</strong> valach ( kastrace 6.4.2011 )<br /> <strong>Otec:</strong> 2901 Lancelot<br /> <strong>Matka:</strong> 49/258 Quinta<br /> <strong>Datum narozen&iacute;:</strong> 20.5.2008<br /> <strong>Barva:</strong> tmav&yacute; hněd&aacute;k</span></p>\r\n<p style="text-align: justify;">&nbsp;</p>\r\n<p style="text-align: justify;">&nbsp;</p>\r\n<p>&nbsp;</p>\r\n</div>', 5),
(6, 'Ory', '<div id="wrapper-top">\r\n<div id="main-content">\r\n<div id="heading-content">\r\n<h1>Ory</h1>\r\n</div>\r\n<div class="editable">\r\n<p><img style="float: right;" src="/img/dsc07365.jpg" alt="" /></p>\r\n<p>&nbsp;</p>\r\n<p style="text-align: justify;"><br /><span style="font-size: 16px;"><strong>Plemeno:</strong>&nbsp;česk&yacute; teplokrevn&iacute;k</span><br /><span style="font-size: 16px;"><strong>Pohlav&iacute;</strong>: valach</span><br /><span style="font-size: 16px;"><strong>Otec:</strong> 2144 Serv&aacute;tor - 21</span><br /><span style="font-size: 16px;"><strong>Matka:</strong> Olivia</span><br /><span style="font-size: 16px;"><strong>Datum narozen&iacute;:</strong> 23.2.1994</span><br /><span style="font-size: 16px;"><strong>Barva</strong>: ryz&aacute;k</span></p>\r\n<p style="text-align: justify;">&nbsp;</p>\r\n<p>&nbsp;</p>\r\n</div>\r\n</div>\r\n</div>', 6),
(7, 'Soňa', '<div id="heading-content">\r\n<h1>SOŇA</h1>\r\n</div>\r\n<div class="editable">\r\n<p><img style="float: right;" src="/img/img_5530.jpg" alt="" /></p>\r\n<p>&nbsp;</p>\r\n<p><span style="font-size: 16px;"><strong> Plemeno:</strong>&nbsp;norick&yacute; kůň<br /> <strong>Pohlav&iacute;</strong>: klisna<br /> <strong>Otec</strong>: 2691 Streimur<br /> <strong>Matka:</strong> SM 2644 Silva<br /> <strong>Datum narozen&iacute;</strong>: 15.6.1999<br /> <strong>Barva:</strong> červen&aacute; bělka</span></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n</div>', 7),
(8, 'Leona', '<div id="heading-content">\r\n<h1>Leona</h1>\r\n</div>\r\n<div class="editable">\r\n<p><img style="float: right;" src="/img/leona.jpg" alt="" /></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p><span style="font-size: 16px;"><strong>Jm&eacute;no: </strong>Leona<br /> <strong>Plemeno</strong>: furioso<br /> <strong>Pohlav&iacute;:</strong> klisna<br /> <strong>Otec:</strong> 3461 Lumen<br /> <strong>Matka:</strong> 151 Furioso XLVII-71<br /> <strong>Datum</strong> 12.6.1995<br /> <strong>Barva:</strong> tmav&aacute; hnědka<br /></span></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p><strong><span style="color: #ff0000;"><span style="font-size: 16px;">&nbsp;</span></span></strong></p>\r\n</div>', 8),
(9, 'Bono', '<div id="heading-content">\r\n<h1>Bono</h1>\r\n</div>\r\n<div class="editable">\r\n<p><img style="float: right;" src="/img/bony1.jpg" alt="" /></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p><span style="font-size: 16px;"> <strong>Plemeno:</strong> Slovensk&yacute; teplokrevn&iacute;k<br /> <strong>Pohlav&iacute;:</strong> valach<br /> <strong>Otec:</strong> 4556 Baldini<br /> <strong>Matka:</strong> 4032 Bona<br /> <strong>Datum narozen&iacute;:</strong> 10.5. 2006<br /> <strong>Barva:</strong> ryz&aacute;k<br /></span></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p><strong><span style="color: #ff0000;"><span style="font-size: 16px;">&nbsp;</span></span></strong></p>\r\n</div>', 9),
(10, 'Noris', '<h1>Noris</h1>\r\n<p><br /><strong>Plemeno: </strong>hafling<br /><strong>Pohlav&iacute;:&nbsp;</strong>valach<br /><strong>Otec:&nbsp;</strong>854 NIMROD<br /><strong>Matka:&nbsp;</strong>SABINA<br /><strong>Datum narozen&iacute;: </strong>16.3.2008<br /><strong>Barva: </strong>světl&yacute; ryz&aacute;k</p>', 10),
(11, 'Gasper', '<h1>Gasper</h1>\r\n<p>&nbsp;</p>\r\n<p><strong>Přezd&iacute;vka: </strong>Gaspy, Gasp&iacute;ček&nbsp;<strong><br />Plemeno:&nbsp;</strong>Hafling<strong><br />Pohlav&iacute;:&nbsp;</strong>valach<strong><br />Otec:&nbsp;</strong>2783 &nbsp;NOBY<strong><br />Matka:&nbsp;</strong>8/448 GLADIS<strong><br />Datum narozen&iacute;:</strong>&nbsp;6.7.2009<strong><br />Barva: </strong>světl&yacute; ryz&aacute;k</p>', 11);

-- --------------------------------------------------------

--
-- Struktura tabulky `soubory_menu`
--

DROP TABLE IF EXISTS `soubory_menu`;
CREATE TABLE IF NOT EXISTS `soubory_menu` (
  `id` int(11) NOT NULL,
  `id_content_menu` int(11) NOT NULL,
...
--
-- Vypisuji data pro tabulku `soubory_menu`
--

INSERT INTO `soubory_menu` (`id`, `id_content_menu`, `nazev`, `cesta`, `poradi`) VALUES
(8, 37, 'list účastníka a lékařské potvrzení', 'soubory/listlekar_1.docx', 2),
(9, 36, 'Prohlášení zákonných zástupců + potvrzení lékař', 'soubory/listlekar_2.docx', 1),
(11, 38, 'list účastníka a lékařské potvrzení', 'soubory/listlekar_3.docx', 2),
(14, 38, 'přihláška', 'soubory/pYihlaYka_vzor.doc', 3),
(15, 36, 'Přihláška 2017', 'soubory/Prihlaska_3_1.doc', 3),
(16, 37, 'Přihláška 2017', 'soubory/PYihlaYka.doc', 3);
...
--
-- Klíče pro tabulku `soubory_menu`
--
ALTER TABLE `soubory_menu`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `content_menu`
  MODIFY `id_content_Menu` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=39;
--
...
--
-- AUTO_INCREMENT pro tabulku `soubory_menu`
--
ALTER TABLE `soubory_menu`
